...
function setup() {
 ...
 bg1.scale = 2;
 var building11 = createSprite(displayWidth/2,200,20,20);
 building11.addImage("img",buildingImg);

/* nonplayer1 = createSprite(-200,105,30,30)
 nonplayer1.addAnimation("runing",nonplayerImg)
 nonplayer1.debug = true
 nonplayer1.scale = 0.2
 nonplayer1.setCollider("rectangle",0,0,850,460)
 nonplayer1.visible = false;*/

 Ground1 = createSprite(width/2,390,20000,20)
Ground1.debug = true
Ground1.shapeColor = "orange"
 Ground22 = createSprite(-50,130,500,10);


//var Ground3 = createSprite(200,110,10,50)

 plr11 = createSprite(100,200)
// plr11.addAnimation("player1",plr1Img)
plr11.scale = 0.25
plr11.setCollider("rectangle",0,0,100,100)
plr11.debug = true
plr11.velocityX=1
